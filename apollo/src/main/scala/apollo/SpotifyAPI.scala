...
//         // Check if the albumId is already processed
//         if (os.exists(jsonPaths("tracks") / s"$albumId.json")) {
//             println(s"getAlbumTracks ($albumId): Skipping album (already processed)")
//             return List()
//         }
